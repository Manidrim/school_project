...
const createHeartIcon = (): JSX.Element => (
  <svg
...
const createRibbon = (): JSX.Element => (
  <a
...
const createMainContent = (): JSX.Element => (
  <div className="flex flex-1 flex-col items-center text-center | md:text-left md:items-start">
    <h1>
      ...
      <Image alt="API Platform" src={logo as IImageSrc} />
    </h1>
...
const createHeroSection = (): JSX.Element => (
    ...
    <div className="container flex flex-row pt-24 pb-8 | md:px-20">
      <div className="hidden relative h-full w-2/5 origin-right scale-150 | md:block | lg:scale-100">
        <div className="absolute">
          <Image src={rocketPicture as IImageSrc} alt="" />
        </div>
      </div>
      {createMainContent()}
    </div>
...
const createServicesSection = (): JSX.Element => (
    ...
    <div className="container | md:px-20">
      <div className="text-center | lg:text-left lg:w-3/5 lg:ml-auto">
        ...
        <div className="flex justify-center flex-wrap | lg:justify-start lg:grid lg:gap-5 lg:grid-cols-2">
          <Card image={(apiPicture as IImageSrc).src} title="API" url="/docs" />
          <Card image={(adminPicture as IImageSrc).src} title="Admin" url="/admin" />
          <Card
            image={(mercurePicture as IImageSrc).src}
...
const createTwitterIcon = (): JSX.Element => (
...
const createMastodonIcon = (): JSX.Element => (
...
const createSocialSection = (): JSX.Element => (
  <div className="bg-white text-center pb-4 | md:shadow-md md:px-0.5 md:py-4 md:grid md:grid-cols-1 md:gap-3 md:fixed md:top-1/2 md:-right-1 md:-translate-y-1/2 md:portrait:bottom-4 md:portrait:top-auto md:portrait:translate-y-0">
    ...
    <HelpButton url="https://twitter.com/ApiPlatform" title="API Platform on Twitter">
      {createTwitterIcon()}
    </HelpButton>
    <HelpButton url="https://fosstodon.org/@ApiPlatform" title="API Platform on Mastodon">
      {createMastodonIcon()}
    </HelpButton>
    <HelpButton url="https://github.com/api-platform/api-platform" title="API Platform on Github">
      {createGithubIcon()}
    </HelpButton>
